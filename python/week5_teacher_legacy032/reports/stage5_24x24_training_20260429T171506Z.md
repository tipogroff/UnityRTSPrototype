...
- json_report: C:\Projects\UnityRTSPrototype\UnityRTSPrototype\python\week5_teacher_legacy032\reports\stage5_24x24_training_20260429T171506Z.json

## Stage Results

| stage | training | checkpoint | metadata | metadata_contract | gate | gate_decision | mean_return | effective_activity_share |
|---|---|---|---|---|---|---|---:|---:|
| 500000 | PASS | PASS | PASS | PASS | PASS | PASS | -7.500000 | 0.833565 |
