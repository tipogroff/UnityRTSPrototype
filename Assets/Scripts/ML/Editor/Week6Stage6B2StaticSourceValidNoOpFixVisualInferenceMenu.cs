...
{
    [InitializeOnLoad]
    public static class Week6Stage6B2StaticSourceValidNoOpFixVisualInferenceMenu
    {
        private const string MenuPath = "RTS/Week6/Stage6B2/Run Static Source-Valid NoOpFix Visual Inference";
        private const string PendingKey = "RTS.Week6.Stage6B2StaticSourceValidNoOpFix.Pending";
        private const string PollCountKey = "RTS.Week6.Stage6B2StaticSourceValidNoOpFix.PollCount";
        private const string BatchExitKey = "RTS.Week6.Stage6B2StaticSourceValidNoOpFix.BatchExit";
        ...
        private const string OutputRelativeDir = "python/week6_student/tmp/stage6b2_static_source_valid_noopfix_visual_inference";
        private const string SnapshotPrefix = "stage6b2_static_source_valid_noopfix_snapshot_step";
        private const string ArtifactPrefix = "stage6b2_static_source_valid_noopfix";
        ...
        static Week6Stage6B2StaticSourceValidNoOpFixVisualInferenceMenu()
        {
        ...
        private static void RunInternal(bool exitEditorOnComplete)
        {
            ...
            Debug.Log("[Stage6B2StaticSourceValidNoOpFix] Entering Play Mode for static visual inference verification...");
        ...
        private static void RunControlledCapture()
        {
            ...
            runner.SetCurrentCaptureModeContext(
                "stage6b2_static_source_valid_noopfix_visual_inference",
            ...
            string manifestPath = Path.Combine(outputDir, "stage6b2_static_source_valid_noopfix_run_manifest.json");
            string manifestJson = "{\n"
            ...
            Debug.Log("[Stage6B2StaticSourceValidNoOpFix] Visual inference capture complete. Manifest: " + manifestPath);
        }
        ...
        private static void WriteFailureReport(string status, string error)
        {
            ...
            string outputDir = Path.GetFullPath(Path.Combine(projectRoot, OutputRelativeDir));
            Directory.CreateDirectory(outputDir);
            string path = Path.Combine(outputDir, "stage6b2_static_source_valid_noopfix_run_manifest.json");
            string json = "{\n"
                + "  \"generated_at_utc\": \"" + DateTime.UtcNow.ToString("O", CultureInfo.InvariantCulture) + "\",\n"
            ...
            Debug.LogError("[Stage6B2StaticSourceValidNoOpFix] Failure report written: " + path);
        }
