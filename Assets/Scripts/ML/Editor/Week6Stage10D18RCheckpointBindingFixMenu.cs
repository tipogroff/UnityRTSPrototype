...
{
    [InitializeOnLoad]
    public static class Week6Stage10D18RCheckpointBindingFixMenu
    {
        private const string MenuPath = "RTS/Week6/Stage10D18R/Run Checkpoint Binding Fix Verification";
        private const string PendingKey = "RTS.Week6.Stage10D18R.Pending";
        private const string PollCountKey = "RTS.Week6.Stage10D18R.PollCount";
        private const int MaxPolls = 300;
        private const int TargetSteps = 1;

        private const string TargetScenePath = "Assets/Scenes/Week6_StudentVisualInspection.unity";
        private const string OutputRelativeDir = "python/week6_student/tmp/stage10d18r_checkpoint_binding_fix";
        private const string SnapshotPrefix = "stage10d18r_snapshot_step";
        private const string ArtifactPrefix = "stage10d18r_binding_fix";
        private const string TargetCheckpointRelativePath = "python/week6_student/runs/legacy032_v2_stage10d17_movement_augmented_bc_20260503T164734Z/student_bc_stage10d17_movement_augmented_best.pt";

        static Week6Stage10D18RCheckpointBindingFixMenu()
        {
        ...
        public static void Run()
        {
            ...
            Debug.Log("[Stage10D18R] Entering Play Mode for checkpoint binding fix verification...");
        ...
        private static void PollPendingRun()
        {
            ...
            if (runner == null || controller == null || matchManager == null || adapter == null)
            {
                ...
                SessionState.EraseBool(PendingKey);
                SessionState.EraseInt(PollCountKey);
                Debug.LogError("[Stage10D18R] Runtime references not ready in Play Mode.");
        ...
        private static void RunControlledCapture()
        {
            ...
            if (runner == null || controller == null || matchManager == null || adapter == null)
            {
                Debug.LogError("[Stage10D18R] Missing runtime components.");
                return;
            }
            ...
            string manifestPath = Path.Combine(outputDir, "stage10d18r_run_manifest.json");
            string manifestJson = "{\n"
            ...
            Debug.Log("[Stage10D18R] Checkpoint binding capture complete. Manifest: " + manifestPath);
        }
