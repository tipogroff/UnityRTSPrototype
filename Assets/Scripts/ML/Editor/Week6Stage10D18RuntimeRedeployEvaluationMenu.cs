...
{
    [InitializeOnLoad]
    public static class Week6Stage10D18RuntimeRedeployEvaluationMenu
    {
        private const string MenuPath = "RTS/Week6/Stage10D18/Run Runtime BC Redeploy Evaluation";
        private const string PendingKey = "RTS.Week6.Stage10D18.Pending";
        private const string PollCountKey = "RTS.Week6.Stage10D18.PollCount";
        ...
        private const string OutputRelativeDir = "python/week6_student/tmp/stage10d18_runtime_redeploy";
        private const string SnapshotPrefix = "stage10d18_snapshot_step";
        private const string ArtifactPrefix = "stage10d18_runtime_redeploy";
        ...
        static Week6Stage10D18RuntimeRedeployEvaluationMenu()
        {
        ...
        public static void Run()
        {
            ...
            Debug.Log("[Stage10D18] Entering Play Mode for runtime BC redeploy evaluation...");
        ...
        private static void PollPendingRun()
        {
            ...
            if (runner == null || controller == null || matchManager == null || adapter == null)
            {
                ...
                SessionState.EraseBool(PendingKey);
                SessionState.EraseInt(PollCountKey);
                Debug.LogError("[Stage10D18] Runtime references not ready in Play Mode.");
        ...
        private static void RunControlledCapture()
        {
            ...
            if (runner == null || controller == null || matchManager == null || adapter == null)
            {
                Debug.LogError("[Stage10D18] Missing runtime components.");
                return;
            }
            ...
            string manifestPath = Path.Combine(outputDir, "stage10d18_run_manifest.json");
            string manifestJson = "{\n"
            ...
            Debug.Log("[Stage10D18] Runtime redeploy capture complete. Manifest: " + manifestPath);
        }
