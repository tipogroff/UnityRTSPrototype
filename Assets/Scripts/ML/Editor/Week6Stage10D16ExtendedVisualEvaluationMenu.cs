...
{
    [InitializeOnLoad]
    public static class Week6Stage10D16ExtendedVisualEvaluationMenu
    {
        private const string MenuPath = "RTS/Week6/Stage10D16/Run Extended Visual Evaluation";
        private const string PendingKey = "RTS.Week6.Stage10D16.Pending";
        private const string PollCountKey = "RTS.Week6.Stage10D16.PollCount";
        ...
        private const string OutputRelativeDir = "python/week6_student/tmp/stage10d16_extended_runtime";
        private const string SnapshotPrefix = "stage10d16_snapshot_step";

        static Week6Stage10D16ExtendedVisualEvaluationMenu()
        {
        ...
        public static void Run()
        {
            ...
            Debug.Log("[Stage10D16] Entering Play Mode for extended visual evaluation...");
        ...
        private static void PollPendingRun()
        {
            ...
            if (runner == null || controller == null || matchManager == null)
            {
                if (polls < MaxPolls)
                {
                    return;
                ...
                SessionState.EraseBool(PendingKey);
                SessionState.EraseInt(PollCountKey);
                Debug.LogError("[Stage10D16] Runtime references not ready in Play Mode.");
        ...
        private static void RunControlledCapture()
        {
            ...
            if (runner == null || controller == null || matchManager == null)
            {
                Debug.LogError("[Stage10D16] Missing runtime components.");
                return;
            }
            ...
            string manifestPath = Path.Combine(outputDir, "stage10d16_run_manifest.json");
            string manifestJson = "{\n"
            ...
            Debug.Log("[Stage10D16] Extended capture complete. Manifest: " + manifestPath);
        }
