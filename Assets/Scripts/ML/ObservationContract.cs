...
namespace RTS.ML
{
    ...
    /// [26]                   attack_target         Observation-side диагностический сигнал local 7x7 (index+1)/49, либо no-target=0
    /// ─────────────────────────────────────────────────────────────────────────
    ...
    public static class ObservationContract
    {
        ...
        // attack_target semantics (v2 diagnostic channel):
        // - local target space is ActionContract local 7x7 indexing [0..48], center=24.
        // - encoding: (localIndex + 1) / SIZE_ATTACK_TARGET -> range [1/49 .. 1.0] for valid targets.
        ...
        //   authoritative runtime truth remains in ActionApplier/MatchManager and is NOT reflected here.
