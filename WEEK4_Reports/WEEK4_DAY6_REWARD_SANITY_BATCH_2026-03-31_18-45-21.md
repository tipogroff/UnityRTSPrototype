...
**Date:** 2026-03-31 18:45:21
**Episodes:** 10
**Mode:** Baseline/Heuristic

## Executive Summary

⚠️  **8 sanity warnings detected.** See details below.

## Reward Statistics

| Metric | Value |
|--------|-------|
| Total Mean ± Std | 0,00 ± 0,00 |
| Total Range | [0,00, 0,00] |
| Economy | 0,00 |
| Combat | 0,00 |
| Terminal | 0,00 |
...
| Avg Invalid Rate (Measured Only) | 199,8% |
| Max Invalid Rate (Measured Only) | 199,8% |
| Episodes with High Rate (>15%, Measured Only) | 10 |

## Sanity Check Results

⚠️  **8 warnings:**

- ⚠️ Reward starvation: mean total reward = 0,00 (threshold: 1)
- ⚠️ High zero-reward rate: 100,0% episodes with reward ≈ 0 (threshold: 80,0%)
- ⚠️ High invalid action rate (measured only): avg = 199,8% (threshold: 15,0%). Action mask or decoder may be poorly configured.
- ⚠️ Extreme invalid rate detected (measured only): max = 199,8% (threshold: 30,0%)
- ⚠️ Many measured episodes with high invalid rate: 100,0% of measured episodes (threshold: 30,0%)
...
|---|--------|-------|---------|--------|----------|---------|---------|-----------|-----------|
| 02 | 0,00 | 2000 | 0,00 | 0,00 | 0,00 | 0,00 | Timeout  | 200% | ✓ |
| 03 | 0,00 | 2000 | 0,00 | 0,00 | 0,00 | 0,00 | Timeout  | 200% | ✓ |
| 04 | 0,00 | 2000 | 0,00 | 0,00 | 0,00 | 0,00 | Timeout  | 200% | ✓ |
| 05 | 0,00 | 2000 | 0,00 | 0,00 | 0,00 | 0,00 | Timeout  | 200% | ✓ |
| 06 | 0,00 | 2000 | 0,00 | 0,00 | 0,00 | 0,00 | Timeout  | 200% | ✓ |
| 07 | 0,00 | 2000 | 0,00 | 0,00 | 0,00 | 0,00 | Timeout  | 200% | ✓ |
| 08 | 0,00 | 2000 | 0,00 | 0,00 | 0,00 | 0,00 | Timeout  | 200% | ✓ |
| 09 | 0,00 | 2000 | 0,00 | 0,00 | 0,00 | 0,00 | Timeout  | 200% | ✓ |
| 10 | 0,00 | 2000 | 0,00 | 0,00 | 0,00 | 0,00 | Timeout  | 200% | ✓ |
| 11 | 0,00 | 2000 | 0,00 | 0,00 | 0,00 | 0,00 | Timeout  | 200% | ✓ |
...
---
Generated by Day6RewardSanitySmokeTest at 2026-03-31 18:45:21
