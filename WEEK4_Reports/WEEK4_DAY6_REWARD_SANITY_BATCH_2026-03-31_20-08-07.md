...
**Date:** 2026-03-31 20:08:07
**Episodes:** 10
**Mode:** Baseline/Heuristic

## Executive Summary

⚠️  **7 sanity warnings detected.** See details below.

## Reward Statistics

| Metric | Value |
|--------|-------|
| Total Mean ± Std | 0,28 ± 0,00 |
| Total Range | [0,28, 0,28] |
| Economy | 0,00 |
| Combat | 0,28 |
| Terminal | 0,00 |
...
| Avg Invalid Rate (Measured Only) | 100,0% |
| Max Invalid Rate (Measured Only) | 100,0% |
...
- ⚠️ Reward starvation: mean total reward = 0,28 (threshold: 1)
- ⚠️ High invalid action rate (measured only): avg = 100,0% (threshold: 15,0%). Action mask or decoder may be poorly configured.
- ⚠️ Extreme invalid rate detected (measured only): max = 100,0% (threshold: 30,0%)
...
|---|--------|-------|---------|--------|----------|---------|---------|-----------|-----------|
| 02 | 0,28 | 2000 | 0,00 | 0,28 | 0,00 | 0,00 | Timeout  | 100% | ✓ |
| 03 | 0,28 | 2000 | 0,00 | 0,28 | 0,00 | 0,00 | Timeout  | 100% | ✓ |
| 04 | 0,28 | 2000 | 0,00 | 0,28 | 0,00 | 0,00 | Timeout  | 100% | ✓ |
| 05 | 0,28 | 2000 | 0,00 | 0,28 | 0,00 | 0,00 | Timeout  | 100% | ✓ |
| 06 | 0,28 | 2000 | 0,00 | 0,28 | 0,00 | 0,00 | Timeout  | 100% | ✓ |
| 07 | 0,28 | 2000 | 0,00 | 0,28 | 0,00 | 0,00 | Timeout  | 100% | ✓ |
| 08 | 0,28 | 2000 | 0,00 | 0,28 | 0,00 | 0,00 | Timeout  | 100% | ✓ |
| 09 | 0,28 | 2000 | 0,00 | 0,28 | 0,00 | 0,00 | Timeout  | 100% | ✓ |
| 10 | 0,28 | 2000 | 0,00 | 0,28 | 0,00 | 0,00 | Timeout  | 100% | ✓ |
| 11 | 0,28 | 2000 | 0,00 | 0,28 | 0,00 | 0,00 | Timeout  | 100% | ✓ |
...
---
Generated by Day6RewardSanitySmokeTest at 2026-03-31 20:08:07
