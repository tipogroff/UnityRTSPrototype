...
**Date:** 2026-03-31 23:49:41
**Episodes:** 20
**Mode:** Diagnostic baseline snapshot (heuristic-vs-idle)

> This run uses a diagnostic-only control setup (Heuristic vs Idle). It is intended for sanity inspection and should not be interpreted as a general gameplay distribution baseline.

## Executive Summary

⚠️  **2 sanity warnings detected.** See details below.
...
| Terminal Reward Non-Zero | 20/20 (100,0%) |
...
|---|--------|-------|---------|--------|----------|---------|---------|-----------|-----------|
| 02 | 3,22 | 2000 | 3,19 | 0,28 | -0,25 | 0,00 | Timeout  | 0% | ✓ |
| 03 | 3,22 | 2000 | 3,19 | 0,28 | -0,25 | 0,00 | Timeout  | 0% | ✓ |
| 04 | 3,22 | 2000 | 3,19 | 0,28 | -0,25 | 0,00 | Timeout  | 0% | ✓ |
| 05 | 3,22 | 2000 | 3,19 | 0,28 | -0,25 | 0,00 | Timeout  | 0% | ✓ |
| 06 | 3,22 | 2000 | 3,19 | 0,28 | -0,25 | 0,00 | Timeout  | 0% | ✓ |
| 07 | 3,22 | 2000 | 3,19 | 0,28 | -0,25 | 0,00 | Timeout  | 0% | ✓ |
| 08 | 3,22 | 2000 | 3,19 | 0,28 | -0,25 | 0,00 | Timeout  | 0% | ✓ |
| 09 | 3,22 | 2000 | 3,19 | 0,28 | -0,25 | 0,00 | Timeout  | 0% | ✓ |
| 10 | 3,22 | 2000 | 3,19 | 0,28 | -0,25 | 0,00 | Timeout  | 0% | ✓ |
| 11 | 3,22 | 2000 | 3,19 | 0,28 | -0,25 | 0,00 | Timeout  | 0% | ✓ |
...
- **Scenario Scope:** Heuristic-vs-idle is a diagnostic-only scenario; treat outcome distribution as a narrow sanity signal, not a general baseline gameplay profile.
...
---
Generated by Day6RewardSanitySmokeTest at 2026-03-31 23:49:41
