...
- run_id: `behavior_first_20260426T184712Z`
- run_status: `completed_with_failures`
- retraining_dir: `WEEK5R\movement_warmup_sweeps\movement_warmup_sweep_20260426T171413Z\runs\stronger_balanced_seed170\retraining_runs\behavior_first_20260426T184712Z`
- gate_dir: `WEEK5R\movement_warmup_sweeps\movement_warmup_sweep_20260426T171413Z\runs\stronger_balanced_seed170\gate_runs\behavior_first_20260426T184712Z`
- gate_comparison_md: `WEEK5R\movement_warmup_sweeps\movement_warmup_sweep_20260426T171413Z\runs\stronger_balanced_seed170\gate_runs\behavior_first_20260426T184712Z\TEACHER_BEHAVIOR_GATE_COMPARISON.md`
- min_abort_step: `5000`
...
- Abort suppressed at step 5000 (checkpoint_step 5000 <= min_abort_step 5000): effective_position_delta_count==0; no_effect_action_share>0.80 — continuing to next checkpoint.
...
|---|---|---:|---:|---:|---:|---|---|---|
| 2000 | SUSPICIOUS | 0.0013 | 0.9893 | 1 | 0.9925 | True | False | n/a |
| 5000 | FAIL_NO_EFFECT_BEHAVIOR | 0.0085 | 0.9394 | 0 | 0.9913 | False | False | n/a |
| 10000 | FAIL_COLLAPSED_NOOP | 0.0000 | 0.9980 | 0 | 1.0000 | False | False | n/a |
