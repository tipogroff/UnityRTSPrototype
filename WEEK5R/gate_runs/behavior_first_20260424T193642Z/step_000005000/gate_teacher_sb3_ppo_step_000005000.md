...
Generated at (UTC): 2026-04-24T20:32:51Z
Schema: `teacher_behavior_gate.v1`

## Checkpoint
- Path: `C:\Projects\UnityRTSPrototype\UnityRTSPrototype\WEEK5R\retraining_runs\behavior_first_20260424T193642Z\checkpoints\teacher_sb3_ppo_step_000005000.zip`
...
### FAIL Reasons
- FAIL_FALSE_FULL_TENSOR_MOVE: full_tensor_move=0.2540 >= 0.10 but actor_level_move=0.0000 < 0.05 (spurious tensor signal, not real movement)
- FAIL_NO_EFFECT_BEHAVIOR: chosen_count=4, no_effect_share=1.0000 > 0.80, pos_delta=0
...
| Metric | Value |
|---|---|
| full_tensor_move_share | 0.2540 (25.40%) |
| actor_level_move_share | 0.0000 (0.00%) |
| actor_noop_share | 0.0000 (0.00%) |
| ready_own_actor_count | 18 |
| steps_with_ready_actors | 14 |
| steps_with_movable_ready_actors | 2 |
| ready_movable_actor_choice_count | 2 |
| ready_movable_actor_count (legacy alias, step-level proxy) | 2 |
...
| chosen_ready_own_actor_count | 4 |
| steps_executed (effective audit) | 50 |
...
- Triggered: True
  - full_tensor_move_share: 0.253994
  - actor_level_move_share: 0.0
  - threshold_full: 0.1
