...
- Adapted batch dir: C:\Projects\UnityRTSPrototype\UnityRTSPrototype\WEEK5R\teacher_exports_v2\teacher_adapted_gridnet_200k_stoch_ab_v2_20260428T000000Z
...
- action_type=0: 197783
- action_type=1: 196205
- action_type=2: 196022
- action_type=3: 196249
- action_type=4: 196661
- action_type=5: 196728
- Imbalance ratio (max/min non-zero share): 1.008984

## Weak Spots

- No dominant weak spot detected in this batch-level sanity scan.

## Top Problematic Episodes

- episode_id=0, score=8.0000, remap_share=0.000000, weakened_share=0.000000, dropped_share=0.000000
- episode_id=1, score=8.0000, remap_share=0.000000, weakened_share=0.000000, dropped_share=0.000000
- episode_id=2, score=8.0000, remap_share=0.000000, weakened_share=0.000000, dropped_share=0.000000
- episode_id=3, score=8.0000, remap_share=0.000000, weakened_share=0.000000, dropped_share=0.000000

## Hard Failures

- metadata.action_branch_contract: conversion_report target_action_branch_sizes mismatch
- action.branch_range.5: branch values are outside allowed range
- action.branch_range.6: branch values are outside allowed range
- action.branch_range.5: branch values are outside allowed range
- action.branch_range.6: branch values are outside allowed range
- action.branch_range.5: branch values are outside allowed range
- action.branch_range.6: branch values are outside allowed range
